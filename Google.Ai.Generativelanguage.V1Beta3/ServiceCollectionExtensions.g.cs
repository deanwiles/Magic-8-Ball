...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gagv::PermissionServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddPermissionServiceClient(this IServiceCollection services, sys::Action<gagv::PermissionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gagv::PermissionServiceClientBuilder builder = new gagv::PermissionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
