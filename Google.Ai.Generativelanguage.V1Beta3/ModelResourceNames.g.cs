...
namespace Google.Ai.Generativelanguage.V1Beta3
{
    ...
    public sealed partial class ModelName : gax::IResourceName, sys::IEquatable<ModelName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>models/{model}</c>.</summary>
            Model = 1,
        }

        private static gax::PathTemplate s_model = new gax::PathTemplate("models/{model}");
        ...
        /// <summary>Creates a <see cref="ModelName"/> with the pattern <c>models/{model}</c>.</summary>
        ...
        public static ModelName FromModel(string modelId) =>
            new ModelName(ResourceNameType.Model, modelId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)));
        ...
        /// <param name="modelId">The <c>Model</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ModelName"/> with pattern <c>models/{model}</c>.
        /// </returns>
        public static string Format(string modelId) => FormatModel(modelId);
        ...
        /// The string representation of this <see cref="ModelName"/> with pattern <c>models/{model}</c>.
        /// </returns>
        public static string FormatModel(string modelId) =>
            s_model.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)));

        /// <summary>Parses the given resource name string into a new <see cref="ModelName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet"><item><description><c>models/{model}</c></description></item></list>
        /// </remarks>
        ...
        public static bool TryParse(string modelName, bool allowUnparsed, out ModelName result)
        {
            ...
            if (s_model.TryParseName(modelName, out resourceName))
            {
                result = FromModel(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ModelName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string modelId = null)
        {
            Type = type;
        ...
        /// </summary>
        /// <param name="modelId">The <c>Model</c> ID. Must not be <c>null</c> or empty.</param>
        public ModelName(string modelId) : this(ResourceNameType.Model, modelId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.Model: return s_model.Expand(ModelId);
