...
namespace Google.Ai.Generativelanguage.V1Beta3
{
    ...
    public sealed partial class TextServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private TextServiceSettings(TextServiceSettings existing) : base(existing)
        {
            ...
            BatchEmbedTextSettings = existing.BatchEmbedTextSettings;
            CountTextTokensSettings = existing.CountTextTokensSettings;
            OnCopy(existing);
        }
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>TextServiceClient.BatchEmbedText</c> and <c>TextServiceClient.BatchEmbedTextAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings BatchEmbedTextSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>TextServiceClient.CountTextTokens</c> and <c>TextServiceClient.CountTextTokensAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CountTextTokensSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class TextServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BatchEmbedTextResponse BatchEmbedText(BatchEmbedTextRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(BatchEmbedTextRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(BatchEmbedTextRequest request, st::CancellationToken cancellationToken) =>
            BatchEmbedTextAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BatchEmbedTextResponse BatchEmbedText(string model, scg::IEnumerable<string> texts, gaxgrpc::CallSettings callSettings = null) =>
            BatchEmbedText(new BatchEmbedTextRequest
            {
                Model = gax::GaxPreconditions.CheckNotNullOrEmpty(model, nameof(model)),
                Texts =
                {
                    gax::GaxPreconditions.CheckNotNull(texts, nameof(texts)),
                },
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(string model, scg::IEnumerable<string> texts, gaxgrpc::CallSettings callSettings = null) =>
            BatchEmbedTextAsync(new BatchEmbedTextRequest
            {
                Model = gax::GaxPreconditions.CheckNotNullOrEmpty(model, nameof(model)),
                Texts =
                {
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(string model, scg::IEnumerable<string> texts, st::CancellationToken cancellationToken) =>
            BatchEmbedTextAsync(model, texts, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BatchEmbedTextResponse BatchEmbedText(ModelName model, scg::IEnumerable<string> texts, gaxgrpc::CallSettings callSettings = null) =>
            BatchEmbedText(new BatchEmbedTextRequest
            {
                ModelAsModelName = gax::GaxPreconditions.CheckNotNull(model, nameof(model)),
                Texts =
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(ModelName model, scg::IEnumerable<string> texts, gaxgrpc::CallSettings callSettings = null) =>
            BatchEmbedTextAsync(new BatchEmbedTextRequest
            {
                ModelAsModelName = gax::GaxPreconditions.CheckNotNull(model, nameof(model)),
                Texts =
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(ModelName model, scg::IEnumerable<string> texts, st::CancellationToken cancellationToken) =>
            BatchEmbedTextAsync(model, texts, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual CountTextTokensResponse CountTextTokens(CountTextTokensRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(CountTextTokensRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(CountTextTokensRequest request, st::CancellationToken cancellationToken) =>
            CountTextTokensAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual CountTextTokensResponse CountTextTokens(string model, TextPrompt prompt, gaxgrpc::CallSettings callSettings = null) =>
            CountTextTokens(new CountTextTokensRequest
            {
                Model = gax::GaxPreconditions.CheckNotNullOrEmpty(model, nameof(model)),
                Prompt = gax::GaxPreconditions.CheckNotNull(prompt, nameof(prompt)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(string model, TextPrompt prompt, gaxgrpc::CallSettings callSettings = null) =>
            CountTextTokensAsync(new CountTextTokensRequest
            {
                Model = gax::GaxPreconditions.CheckNotNullOrEmpty(model, nameof(model)),
                Prompt = gax::GaxPreconditions.CheckNotNull(prompt, nameof(prompt)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(string model, TextPrompt prompt, st::CancellationToken cancellationToken) =>
            CountTextTokensAsync(model, prompt, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual CountTextTokensResponse CountTextTokens(ModelName model, TextPrompt prompt, gaxgrpc::CallSettings callSettings = null) =>
            CountTextTokens(new CountTextTokensRequest
            {
                ModelAsModelName = gax::GaxPreconditions.CheckNotNull(model, nameof(model)),
                Prompt = gax::GaxPreconditions.CheckNotNull(prompt, nameof(prompt)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(ModelName model, TextPrompt prompt, gaxgrpc::CallSettings callSettings = null) =>
            CountTextTokensAsync(new CountTextTokensRequest
            {
                ModelAsModelName = gax::GaxPreconditions.CheckNotNull(model, nameof(model)),
                Prompt = gax::GaxPreconditions.CheckNotNull(prompt, nameof(prompt)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<CountTextTokensResponse> CountTextTokensAsync(ModelName model, TextPrompt prompt, st::CancellationToken cancellationToken) =>
            CountTextTokensAsync(model, prompt, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class TextServiceClientImpl : TextServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<BatchEmbedTextRequest, BatchEmbedTextResponse> _callBatchEmbedText;

        private readonly gaxgrpc::ApiCall<CountTextTokensRequest, CountTextTokensResponse> _callCountTextTokens;
        ...
        public TextServiceClientImpl(TextService.TextServiceClient grpcClient, TextServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callBatchEmbedText = clientHelper.BuildApiCall<BatchEmbedTextRequest, BatchEmbedTextResponse>("BatchEmbedText", grpcClient.BatchEmbedTextAsync, grpcClient.BatchEmbedText, effectiveSettings.BatchEmbedTextSettings).WithGoogleRequestParam("model", request => request.Model);
            Modify_ApiCall(ref _callBatchEmbedText);
            Modify_BatchEmbedTextApiCall(ref _callBatchEmbedText);
            _callCountTextTokens = clientHelper.BuildApiCall<CountTextTokensRequest, CountTextTokensResponse>("CountTextTokens", grpcClient.CountTextTokensAsync, grpcClient.CountTextTokens, effectiveSettings.CountTextTokensSettings).WithGoogleRequestParam("model", request => request.Model);
            Modify_ApiCall(ref _callCountTextTokens);
            Modify_CountTextTokensApiCall(ref _callCountTextTokens);
        ...
        partial void Modify_BatchEmbedTextApiCall(ref gaxgrpc::ApiCall<BatchEmbedTextRequest, BatchEmbedTextResponse> call);

        partial void Modify_CountTextTokensApiCall(ref gaxgrpc::ApiCall<CountTextTokensRequest, CountTextTokensResponse> call);
        ...
        partial void Modify_BatchEmbedTextRequest(ref BatchEmbedTextRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_CountTextTokensRequest(ref CountTextTokensRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override BatchEmbedTextResponse BatchEmbedText(BatchEmbedTextRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_BatchEmbedTextRequest(ref request, ref callSettings);
            return _callBatchEmbedText.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<BatchEmbedTextResponse> BatchEmbedTextAsync(BatchEmbedTextRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_BatchEmbedTextRequest(ref request, ref callSettings);
            return _callBatchEmbedText.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override CountTextTokensResponse CountTextTokens(CountTextTokensRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CountTextTokensRequest(ref request, ref callSettings);
            return _callCountTextTokens.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<CountTextTokensResponse> CountTextTokensAsync(CountTextTokensRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CountTextTokensRequest(ref request, ref callSettings);
            return _callCountTextTokens.Async(request, callSettings);
        }
    }
}
